...
<style>
	body{
background-image: url("gun.jpg"); /*You will specify your image path here.*/
...
<h1>Best Of Mystery</h1>


<div id="a">
<h2>1.</h2>
<img src="behind bars.jpg">
<h3>Behind Bars</h3>
<p>by E. C. Mtize</p>
...
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="1" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" class="button" onclick="window.open('behind-bars.pdf','_blank')" name="read" value="Read"> 
...
<div id="a">
<h2>2.</h2>
<img src="little girl lost.jpg">
<h3>Little Girl Lost</h3>
<p>by Alexandria McClarke</p>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="2" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" class="button" name="read" onclick="window.open('behind-bars.pdf','_blank')" value="Read"> 
</div>
<br>

<div id="a">
<h2>3.</h2>
<img src="seven deaadly sins.jpg">
<h3>Motivating Maddie: Sloth (Seven Deadly Sins 4)</h3>
<p>by Ruth Munro</p>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="3" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" class="button" name="read" onclick="window.open('motivating-maddie-seven-deadly-sins-4-sloth.pdf','_blank')" value="Read"> 
</div>
<br>

<div id="a">
<h2>4.</h2>
<img src="spellchecker.jpg">
<h3>Spellchecker</h3>
<p>by Wolf Scherman</p>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="4" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" class="button" name="read" onclick="window.open('spellchecker.pdf','_blank')" value="Read"> 
</div>
<br>

<div id="a">
<h2>5.</h2>
<img src="surviving the collapse.jpg">
<h3>Surviving The Collapse</h3>
<p>by James Hunt </p>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="5" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" class="button" onclick="window.open('surviving-the-collapse-book-0.pdf','_blank')" name="read" value="Read"> 
</div>
<br>

<div id="a">
<h2>6.</h2>
<img src="their first murder case.jpg">
<h3>Their First Murder Case</h3>
<p>by Phillip N. Hancock, Sr.</p>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star"></span>
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="6" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" onclick="window.open('their-first-murder-case.pdf','_blank')" class="button" name="read" value="Read"> 
</div>
<br>
...
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="7" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" onclick="window.open('the-giver-bookfile.pdf','_blank')" class="button" name="read" value="Read"> 
</div>
<br>
...
<span class="fa fa-star"></span>
<br><br>
<input type="button" id="8" onclick="fun(this.id)" class="button" name="review" value="Review">	<input type="button" onclick="window.open('TheultimateHitchhikersGuide.pdf','_blank')" class="button" name="read" value="Read"> 
</div>
<br>
